...
class Utilities {
    ...
    func showCustomPopup(title: String, body: String, presentingVC: UIViewController) {
        ...
        popupVC.titleLabel.text = title
        popupVC.howToLabel.text = body
    ...
    func showQuitConfirmPopup(presentingVC: UIViewController) {
        let popupVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "quitConfirmPopupID") as! QuitConfirmationPopupViewController
        presentingVC.addChildViewController(popupVC)
        let frame = CGRect(x: presentingVC.view.frame.minX, y: presentingVC.view.frame.minY, width: presentingVC.view.frame.width, height: (presentingVC.view.frame.height + presentingVC.view.safeAreaInsets.bottom))
        popupVC.view.frame = frame
        presentingVC.view.addSubview(popupVC.view)
